...
set_b = {10, -1, 0}
print(f"set_a : {set_a}\nset_b : {set_b}")
print("Is set_a disjoint: ", set_a.isdisjoint(set_b)) # True because there are no overlapping elements.
...
set_b = {0, 10, 20, 30, 40}
print(f"set_a : {set_a}\nset_b : {set_b}")
print("Is set_a subset:", set_a.issubset(set_b)) # True because all of set_a is in set_b.
...
set_b = {-1, 2}
print(f"set_a : {set_a}\nset_b : {set_b}")
print("Is set_a superset: ", set_a.issuperset(set_b)) # True because all of set_b is in set_a.
